...
import Structures.Trees.NodeBasedBinaryTree.Node;
...
public interface SelfBalanced<T extends Comparable<T>> {
     ...
     * @param data the data that was inserted, used to determine the rotation
     *             direction
     * @param ins  tells if it is an isertion or a deletion. Useful if the
     *             conditionals change but the rotations don't
     */
